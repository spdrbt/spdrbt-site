...
export function TrafficOverview() {
  return (
    <IframeWidget
      ...
      src="https://embed.waze.com/iframe?zoom=12&lat=40.73&lon=-73.95&ct=livemap"
      height="550px"
      className="h-full"
    />
  );
...
export function MaritimeTraffic() {
  return (
    <IframeWidget
      ...
      src="https://www.marinetraffic.com/en/ais/embed/zoom:12/centery:40.71/centerx:-74.00/maptype:1/shownames:false/mmsi:0/shipid:0/fleet:/fleet_id:/vessel:/"
      height="600px"
    />
  );
}
